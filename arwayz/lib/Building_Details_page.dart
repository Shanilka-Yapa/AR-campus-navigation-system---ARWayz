  ...
  Widget _buildingCard(BuildingInfo b) {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => BuildingDetailsPage(building: b)),
      ),
      child: Container(
            ...
            DecoratedBox(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [Colors.transparent, _bg.withOpacity(0.6), _bg],
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Icon(Icons.location_on_rounded, color: _accent, size: 13),
              const SizedBox(width: 4),
              Text(
